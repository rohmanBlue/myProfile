    ...
    <div className="w-full flex justify-center pb-10">
      ...
      <nav className="fixed z-50 bg-[#1e1b4b]/40 text-[#f0f9ff] backdrop-blur-md border-b rounded-full my-3 flex justify-center border border-[#8881f8] px-2 sm:px-10 md:px-16 lg:px-1">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-2 sm:px-10 md:px-16 lg:px-1 py-4">
          ...
          <div
            onClick={goHome}
            className="text-2xl sm:text-3xl font-medium cursor-pointer tracking-tight px-4"
          >
          ...
          <div className="hidden md:flex items-center gap-10 text-lg font-light px-6">
            ...
            <button onClick={() => goId("Project")} className="hover:text-blue-400 transition">
              Project 
            </button>
            <button onClick={() => goId("YouTube")} className="hover:text-blue-400 transition items-center flex">
      ...
      {open && (
     <div className="fixed top-20 left-1/2 -translate-x-1/2 z-40 md:hidden flex flex-col items-center w-[90%] bg-[#1e1b4b]/95 backdrop-blur-md border border-[#e1f1fd]/20 rounded-2xl shadow-xl py-6 space-y-3 text-base animate-slideDown">

          <button
            onClick={() => goId("Home")}
            className="w-full text-center py-2 text-[#e0f2fe] hover:bg-[#38bdf8]/20 hover:text-[#bae6fd] transition rounded-lg"
          >
            Home
          </button>
          <button
          ...
          <button
            ...
            className="w-full text-center py-2 text-[#e0f2fe] hover:bg-[#38bdf8]/20 hover:text-[#bae6fd] transition rounded-lg flex items-center justify-center"
          >
            YouTube <MdArrowOutward className="ml-2"/>
          </button>
          <button
          ...
          <CButton
            ...
            className="text-[#e0f2fe] border border-[#7dd3fc]/40 rounded-full px-5 py-2 
              hover:bg-[#7dd3fc] hover:text-[#0f172a] transition"
          >
            linkldn 
          </CButton>
        </div>
